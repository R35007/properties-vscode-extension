		...
		try {
			...
			await vscode.window.withProgress({
				...
				const locationDetails = toString([
					['Root', stats.workspace?.fsPath, Settings.paths.relativeToRoot && Settings.paths.root && stats.workspace],
					['Directory', stats.directory, Settings.paths.directory],
					['Location', stats.location, Settings.paths.location],
				]);
